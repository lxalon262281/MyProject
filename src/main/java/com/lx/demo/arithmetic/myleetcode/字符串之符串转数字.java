 ...
 */
public class 字符串之符串转数字 {
    public static void main(String[] args) {
//        System.out.println(myAtoi("-91283472332"));
//        System.out.println(myAtoi("27485959362820"));
//        System.out.println(myAtoi("+123"));
//        System.out.println(myAtoi("00000000000000000011111222"));
//        System.out.println(myAtoi("-00000000000001"));
//        System.out.println(myAtoi("-42"));
    ...
    public static int myAtoi(String str) {
        ...
        for(int i = start; i < len; i++) {
            ...
            if(i == 9) {
                if (symbol == '-') {
                    if((-1) * result <= Integer.MAX_VALUE / 10) {
