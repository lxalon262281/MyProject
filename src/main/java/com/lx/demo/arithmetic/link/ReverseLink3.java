...
public class ReverseLink3 {
    public static void main(String[] args) {
        ...
        ReverseLink2.ListNode node4 = new ReverseLink2.ListNode(4);
        ReverseLink2.ListNode node5 = new ReverseLink2.ListNode(5);
        ReverseLink2.ListNode node6 = new ReverseLink2.ListNode(6);
        ...
        ReverseLink2.ListNode newNode = reverseKGroup(head,2);
